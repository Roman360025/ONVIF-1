...
mycam = ONVIFCamera('192.168.15.42', 80, 'admin', 'Supervisor', 'C:/Users/profe/AppData/Local/Programs/Python/Python37/Lib/site-packages/wsdl')
...
# Передаём значение фокуса камеры
requesta.Position.Zoom.x = 0.5
